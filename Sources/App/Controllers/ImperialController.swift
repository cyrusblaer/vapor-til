...
struct ImperialController: RouteCollection {
    func boot(router: Router) throws {
        ...
        try router.oAuth(from: Google.self, authenticate: "login-google", callback: callbackURL, scope: ["profile", "email"], completion: processGoolgeLogin)
    }
    
    func processGoolgeLogin(request: Request, token: String) throws -> Future<ResponseEncodable> {
        return try Google
            .getUser(on: request)
